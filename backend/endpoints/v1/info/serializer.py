...
class ApplicationResponseSerializer(Schema):
    ...
    imager_ran = base_fields.Boolean(description='Indicator if the application has the imager enabled')
    imager_status = base_fields.Integer(description='Last known status of the imager')
